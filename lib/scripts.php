...
function roots_scripts() {
  ...
  if (WP_ENV === 'development') {
    $assets = array(
      ...
      'js'        => '/assets/js/scripts.js#defer',
      'modernizr' => '/assets/vendor/modernizr/modernizr.js#defer',
      'jquery'    => '//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.js#defer'
    );
  } else {
    ...
    $assets     = array(
      ...
      'js'        => '/assets/js/scripts.min.js#defer?' . $assets['assets/js/scripts.min.js']['hash'],
      'modernizr' => '/assets/js/vendor/modernizr.min.js#defer',
      'jquery'    => '//ajax.googleapis.com/ajax/libs/jquery/1.11.1/jquery.min.js#defer'
    );
  }
  /**
